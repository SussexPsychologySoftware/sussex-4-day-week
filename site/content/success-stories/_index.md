...
research_findings:
  ...
  description: "The aggregated results below show some of the impacts of the 4 day week across all the employers we've worked with."
  image: "/img/results.png"
  image_alt: "Research Findings Results"

consultant_quote:
  quote: "These are just some of the measures that we take to assess wellbeing and workplace performance in the Sussex 4 Day Week project. We include these, and more, in each employer's custom report. We look forward to sharing more results as the data continues to come in!"
